...
namespace Harfi.Repositories.Migrations
{
    ...
    [Migration("20260630135912_AddDisputeTable")]
    partial class AddDisputeTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Harfi.Models.Entities.Dispute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FavoredParty")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("Harfi.Models.Entities.Dispute", b =>
                {
                    ...
                    b.HasOne("Harfi.Models.Entities.User", "RaisedByUser")
                        .WithMany()
                        .HasForeignKey("RaisedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Harfi.Models.Entities.User", "ResolvedByAdmin")
                        .WithMany()
