...
public class AdminService : IAdminService
{
        ...
        string? status, int? craftsmanId, int? customerId, int page, int pageSize, DateTime? from, DateTime? to)
    {
        ...
        return new PagedResult<JobAdminDto>
        {
            Items = items.Select(j => new JobAdminDto
            {
                ...
                CustomerProfileImageUrl = j.Customer?.ProfileImageUrl,
                CraftsmanProfileImageUrl = j.Craftsman?.User?.ProfileImageUrl,
                Status = j.Status,
    ...
    public async Task<JobDetailDto> GetJobByIdAsync(int id)
    {
        ...
        return new JobDetailDto
        {
            ...
            CustomerProfileImageUrl = job.Customer?.ProfileImageUrl,
            CraftsmanProfileImageUrl = job.Craftsman?.User?.ProfileImageUrl,
            Status = job.Status,
